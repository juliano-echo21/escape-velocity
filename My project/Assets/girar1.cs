...
public class girosuave : MonoBehaviour
{
    public float amplitud = 2f;         // Qué tanto se mueve (arriba y abajo)
    public float velocidad = 0.5f;         // Qué tan rápido se mueve
    public float velocidadRotacion = 0f; // Qué tan rápido gira (grados por segundo)
